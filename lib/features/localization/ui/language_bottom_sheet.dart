        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              RadioTheme(
                ...
                child: RadioGroup<String>(
                  ...
                  child: Column(
                    children: [
                      LanguageTile(
                        title: AppLocalizations.of(context)!.settingsLanguageOptionsEnglish,
                        subtitle: AppLocalizations.of(context)!.settingsDefaultLanguage,
                        value: 'en',
                      ),
                      verticalSpace(8),
                      LanguageTile(
                        title: AppLocalizations.of(context)!.settingsLanguageOptionsArabic,
                        subtitle: AppLocalizations.of(context)!.settingsArabicLanguage,
              ...
              verticalSpace(40),
              FilledAppTextButton(
                buttonText: AppLocalizations.of(context)!.settingsApplySelection,
                onPressed: () async {
