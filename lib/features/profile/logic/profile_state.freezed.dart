...
class UploadingImage<T> implements ProfileState<T> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UploadingImage<T>);
}
...
@override
String toString() {
  return 'ProfileState<$T>.uploadingImage()';
}
